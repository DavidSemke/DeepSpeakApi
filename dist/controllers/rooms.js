...
const getManyRooms = (req, res, next) => {
    many_1.default.findMany(room_1.default, {}, true)(req, res, next);
};
exports.getManyRooms = getManyRooms;
exports.postRoom = (0, express_async_handler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
