...
beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const results = yield Promise.all([
        message_1.default.findOne().lean().exec(),
...
describe("POST /rooms/:roomId/messages", () => {
    ...
    test("User not in room, at max messages", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test("User in room, at max messages", () => __awaiter(void 0, void 0, void 0, function* () {
        const url = `/rooms/${maxMessagesRoom._id}/messages`;
        ...
        yield (0, supertest_1.default)(app)
            ...
            .field("user", message.user)
            .expect(200);
        const room = yield room_1.default.findById(maxMessagesRoom._id).lean().exec();
        if (room === null) {
